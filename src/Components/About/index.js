          ...
          <div class="valinner" id="about">
            ...
            <div className="content">
              <p className="webfont2">
                ...
                la innovación y los sueños se transforman en realidad. Fundada
                en el espíritu de la exploración intelectual y la excelencia
                académica, Sunshine University es un faro de la educación
                superior que tiene como objetivo capacitar a la próxima
          ...
          <div class="valinner" id="prof">
            ...
            <div className="content">
              <p className="webfont2">
                ...
                Inspiran, guían y orientan a los estudiantes para que amplíen
                los límites del conocimiento, animándoles a cuestionar, explorar
                e innovar.
              </p>
            </div>
          </div>
          <div class="valinner" id="inv">
            ...
            <div className="content">
              <p className="webfont2">
                ...
                centros e institutos de investigación colaboran entre
                disciplinas para abordar algunos de los problemas más acuciantes
                del mundo, desde la sostenibilidad hasta los avances en la
                atención sanitaria. Los estudiantes tienen la oportunidad de
                participar en proyectos de investigación prácticos que
                contribuyen a mejorar la sociedad.
              </p>
            </div>
          </div>
        </div>
