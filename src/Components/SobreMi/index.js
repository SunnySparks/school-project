      ...
      <Fade left duration={2800}>
        <div id="sobreMiCont">
          <div id="wording">
            ...
            <div id="content">
                <p  className='webfont2'>Laura Vetchínova es una artista interdisciplinaria que emplea las artes escénicas y plásticas como medio de resignificación de valores personales, cuestionando el concepto de arte, para así lograr el acceso a productos culturales y al desarrollo integral de la persona.
                  ...
                  Actualmente le interesa la investigación, la docencia y la creación escénica. Ha dirigido circo contemporáneo, escrito adaptaciones de obras de teatro y es Directora Creativa del Festival Internacional Tierra de lo Muertos.
                </p>
            </div>
          </div>
          <div id="btn">
            <div className="home-buttons webfont">
              <Link href="#">Sobre Ella</Link>
            </div>
          </div>
        </div>
      </Fade>
